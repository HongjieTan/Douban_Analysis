...
dfc1 = copy.deepcopy(df)
listBins = [0, 10, 30, 60, 100, 200, 500, 100000]
listLabels = ['0_10','11_30','31_60','61_100','101_200','201_500','501<']
dfc1['评价人数'] = pd.cut(dfc1['评价人数'], bins=listBins, labels=listLabels, include_lowest=True)
...
print(pd.crosstab(dfc1.类别,dfc1.评价人数,dfc1.评分,aggfunc='mean'))


# In[32]:


df_group = pd.crosstab(dfc1.类别,dfc1.评价人数,dfc1.评分,aggfunc='mean')
...
dfc2 = copy.deepcopy(df)
listBins = [0, 2, 4, 6, 8, 10]
listLabels = ['1星级','2星级','3星级','4星级','5星级']
dfc2['评分'] = pd.cut(dfc2['评分'], bins=listBins, labels=listLabels, include_lowest=True)
...
df_group = pd.crosstab(dfc2.类别,dfc2.评分)
print(df_group)
...
df_group = pd.crosstab(dfc2.评分,dfc2.类别,dfc2.评价人数,aggfunc='sum').sum()
